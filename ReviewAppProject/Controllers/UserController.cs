...
namespace ReviewAppProject.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        [HttpPost("Edit")]
        public async Task<IActionResult> UpdateUserAsync(UserUpdateModel updateModel) {
            (User? user, Exception? e) = await _service.UpdateUserAsync(updateModel);

            if(user != null && e is null) return Ok(user);
