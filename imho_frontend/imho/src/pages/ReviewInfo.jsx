        ...
        <>
          ...
          <section id="review_info" className=" px-[24px] flex flex-col justify-center items-center">
            <div className='flex flex-col sm:flex-row w-full md:w-[850px] justify-between items-center py-16 gap-y-16'>
              <div className="flex flex-col justify-start w-[500px] gap-y-2 relative ">
                <BackArrow onBack={() => navigate(-1)} text={'Back'}/>
                <p className="text-3xl font-semibold font-KumarOne">{professor.firstName} {professor.lastName}</p>
                {/* <img className="h-[100px] absolute top-20 right-10 -z-10" src={yellow_pen} /> */}
                <p  className="font-bold text-xl">Professor of {professor.faculty.facultyName}</p>
                <p className='text-3xl'>{professor.university.name}</p>
                <div className="flex justify-start items-start">
                      <p className="text-[30px] font-bold">{professor.rating}</p>
                      <p>\5</p>
                    </div>
                <p  className="font-bold text-xl">overall quality based on {professor.reviewsCount} ratings</p>
                <div className="flex justify-start gap-x-3">
                  <div className="border-black border-r-[1px] pr-[20px] w-[50%]">
                    ...
                    <p className='text-xl'>would take again</p>
                  </div>
                  <div>
                    <p className="text-[30px] font-bold">{professor.difficultyPercentage}%</p>
                    <p className='text-xl'>level of difficulty</p>
                  </div>
                </div>
              </div>

              <div className="flex flex-col gap-y-4 bg-black p-[20px]  rounded-[16px]">
