...
import { api_getAllUniversities } from '../api/UniversityApi';
...
const Signup = ({openSignup, setOpenSignup}) => {
  ...
  async function loadUniversities() {
    ...
    .then((dataResponse) => {
      setUniversities(dataResponse)
    })
    .catch(err => console.log(err))
  }

  async function loadFaculties(universityId) {
    await api_getFacultiesInUniversity(universityId)
    .then((dataResponse) => setFaculties(dataResponse))
    .catch(err => console.log(err));
  }
